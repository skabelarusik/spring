...
public class PageConstant {
    ...
    public static final String PATH_PAGE_MAIN_USER = "/jsp/user.jsp";
    public static final String PATH_PAGE_MAIN_ADMIN = "/jsp/admin.jsp";
    public static final String PATH_PAGE_MAIN_CURATOR = "/jsp/curator.jsp";
    public static final String PATH_PAGE_MAIN_SUPERUSER = "/jsp/superuser.jsp";
    public static final String PATH_PAGE_REGISTER = "/jsp/register.jsp";
    ...
    public static final String PATH_DEPOSIT = "/jsp/deposit.jsp";
    public static final String PATH_PICTURE = "/jsp/picture/";
    public static final String PATH_PAGE_UPDATE_PROG = "/jsp/editprogram.jsp";
    public static final String PATH_PAGE_SERVICE = "/jsp/about_service.jsp";
