...
<div class="wrapper">
    ...
    <div class="wrapperBlocks">
        ...
        <div class="block1">
            ...
            <div class="message">
                <a href="/controller_superuser?command=update_profile" class="invisibleForm"><fmt:message key="button.edit" bundle="${rb}"/></a>
            </div>
            <div class="message">
                <h4><fmt:message key="label.message" bundle="${rb}"/></h4>
                <h5><a href="/controller_superuser?command=input_message" class="invisibleForm"><fmt:message key="label.input" bundle="${rb}"/></a></h5>
                <h5><a href="/controller_superuser?command=output_message" class="invisibleForm"><fmt:message key="label.output" bundle="${rb}"/></a></h5>
                <h5><a href="/controller_superuser?command=send_message" class="invisibleForm"><fmt:message key="label.sendmessage" bundle="${rb}"/> </a></h5>
            </div>
        ...
        <div class="block2">
            <div class="searchheader">
                <form class="adviceForm" method="post" action="/controller_superuser">
            ...
            <a href="/controller_superuser?command=logout" class="aBlock2"><h5><fmt:message key="label.logout" bundle="${rb}"/></h5></a>
            <br/>
            <!-- panel users -->
            <div class="wrapperBlock2">
                <div class="blockUsers">
                    ...
                    <div class="blockLearner">
                        ...
                        <a href="/controller_superuser?command=select_user"><h5 class="adminBlock"><fmt:message key="button.show"
                                                                                                           bundle="${rb}"/></h5></a><br/>
                        <h4 class="adminBlock"><fmt:message key="label.showuserstatus" bundle="${rb}"/></h4>
                        <form class="adminBlock" method="post" action="/controller_superuser">
                        ...
                        <form class="adminBlock" method="post" action="/controller_suparuser">
                        ...
                        <a href="/controller_superuser?command=select_user_status&role=admin"><h5 class="adminBlock"><fmt:message key="button.click"
                                                                                                                             bundle="${rb}"/></h5></a><br/>
                    </div>
                ...
                <div class="anotherBlock">
                    <div class="productBlock">
                        <h4 class="adminBlock"><fmt:message key="label.productbox" bundle="${rb}"/></h4><br/>
                        <h4 class="adminBlock"><fmt:message key="label.todayeat" bundle="${rb}" /></h4>
                        <c:forEach items="${programComponent}" var="program">
                            <table border="1" width="220px" class="userTable" cellspacing="0" cellpadding="4" border="1">
                                <tr>
                                    <td class="prod3" width="100px">${program.product}</td>
                                    <td class="prod3" width="20px">${program.portions}</td>
                                    <td class="prod3" width="100px">${program.time}</td>
                                </tr>
                            </table>
                        </c:forEach>
                    </div>
                    ...
                    <div class="blockAdvice">
                        ...
                        <a href="/controller_superuser?command=select_all_products">
                    ...
                    <div class="blockAdvice">
                        ...
                        <a href="/controller_superuser?command=select_all_programs_name&type=1"><h5 class="adminBlock">
                            <fmt:message key="label.show" bundle="${rb}"/></h5></a><br/>

                        <h4 class="adminBlock"><fmt:message bundle="${rb}" key="label.showsub" /></h4>
                        <a href="/controller_superuser?command=show_history_subscription"><h5 class="adminBlock">
