...
UUI.Global_Search = (function() {
    ...
    function Global_Search() {
        ...
        this._afterShowCallback = null;
    }
    Global_Search.prototype.init = function (callback, options) {
        var self = this;
        var $search = $('.uui-global-search .uui-search');
        if (options && options.full_results_page) {
            self._full_results_page = options.full_results_page;
        }
        if (options && options.afterShowCallback) {
            self._afterShowCallback = options.afterShowCallback;
        }
    ...
    Global_Search.prototype.show_results = function(data, query, $search) {
        ...
        if (data.length === 0) {
            ...
            if (self._full_results_page) {
                ...
                $all_results.show();
                if (self._afterShowCallback) {
                    self._afterShowCallback();
                }
            }
            else {
                $all_results.hide();
